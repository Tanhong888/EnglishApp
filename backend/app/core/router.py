...
api_router.include_router(content_router, prefix='/articles', tags=['articles'])
...
api_router.include_router(web_articles_router, prefix='/web-articles', tags=['web_articles'])
